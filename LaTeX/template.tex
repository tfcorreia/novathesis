...
\documentclass[
  ...
  fontstyle=kpfonts,    % baskervaldx bookman charter ebgaramond fbb fourier garamond
                        ...
                        % newpx newtx 
  chapstyle=tiago,      % bianchi bluebox brotherton dash default elegant(*) ell ger 
  ...
  printcommittee=false,  % set to 'false' from submitted versins who should not have 
	...
	biblatex={            % Options for biblatex (see biblatex documentation)
		...
		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		%%% uncomment for 'numeric-by-order-of-citation' like citations
		backend=bibtex8,		  % use bibtex if possible
...
%\setlength{\belowcaptionskip}{-0.5ex} %CUIDADO ----------> REVER
...
%\title{Evaluating the influence of hot forming thermal cycle and material exposure conditions in mechanical and physical properties of prepreg materials}
\title{Hot forming thermal cycle and material exposure effect on prepreg materials properties}
\subtitle{Internship at Embraer Portugal S.A. - Estruturas em Compósitos}

% Autor
% use [f] for female and [m] for male
\authorname[m]{Tiago Filipe Viegas Correia}{Tiago Correia}
\authordegree{Bachelor degree in Materials Science}

\majorfield[pt]={Engenharia de Materiais}
\majorfield[en]={Materials Engineering}
...
% use [f] for female and [m] for male
%\adviser[f]{Filipe Silva}{Process Engineer}{Embraer Portugal - \\&Estruturas em Compósitos, S.A.} 
% you may use "\newline" to force a new line
\adviser[m]{Alexandre Velhinho}{Associate Professor}{NOVAFCT}
% \adviser[m]{John Doe Third Adviser Name}{Associate\\& Professor}{Some University Somewhere}


% Co-Advisers (maximum of 9)
% use [f] for female and [m] for male
\coadviser[f]{Filipe Silva}{Process Engineer}{Embraer Portugal - \\&Estruturas em Compósitos, S.A.}
...
%\addlisttofrontmatter{\printnoidxglossaries}
...
\addlisttofrontmatter{\glsnogroupskiptrue\setlength{\glsdescwidth}{0.8\textwidth}\printnoidxglossary[type=main]}
\addlisttofrontmatter{\glsnogroupskiptrue\setlength{\glsdescwidth}{0.8\textwidth}\printnoidxglossary[type=acronym]} 
\addlisttofrontmatter{\printnoidxglossary[type=symbolslist, style=symbunitlong]}
...
\chapterfile{Physical}
\chapterfile{Mechanical}
